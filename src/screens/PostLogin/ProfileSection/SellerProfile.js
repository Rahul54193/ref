...
const SellerProfile = props => {
  ...
  const getAbbreviatedWeekday = day => {
  ...
  useEffect(() => {
    if (!userDetail.id == 0) {
      getProfileListing({
        userId: authReducer?.userProfileDetails?.id,
        keyword: query,
      });
      return () => {
        if (buoRef.current) {
  ...
  console.log('***********================>>>>> ANNOUNCE', announcementDate);
  ...
  // console.log('ProductList ========>', props?.profileSectionReducer);
        ...
        <View
          ...
          <View style={{flex: 0.88}}>
            {userDetail?.user_id_tag ? (
              <PageTitle
                title={`Watches Posted by @${addEllipsis(
                  userDetail?.user_id_tag,
                  15,
                )}`}
              />
                  ...
                  return item.isEnable === 'true' ? (
                    <View
                      ...
                      <CustomText
                        ...
                        {getAbbreviatedWeekday(item?.lable)}
                    ...
                    <View
                      ...
                      <View style={{marginRight: SPACING.SCALE_60}}>
                        <CustomText
                          style={{
                            marginBottom: 2,
                            justifyContent: 'flex-start',
  ...
  return (
    <ScrollView
      ...
      <Spacer height={20} />
      {console.log('================>ASDKANDKSNA', announcemnetVisble)}

      <View>
        {announcemnetVisble == true ? (
          <Banner
            // resizeMode={'center'}
            bannerData={userDetail?.additional_info?.post_adds ?? []}
          />
        ) : null}
          ...
          <View
            ...
            <View
              style={{
                ...
                // marginHorizontal: SPACING.SCALE_1,
              }}>
              <View
                style={{
                  alignSelf: 'center',
